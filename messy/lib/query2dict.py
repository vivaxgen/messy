        ...
        for arg, field in self.args:
            ...
            try:
                ...
                if field == Field.COLLECTION:
                    self.check_field(Field.COLLECTION, expr)
                    expr[Field.COLLECTION] = arg
                elif field == Field.COLLECTION_ID:
                    self.check_field(Field.COLLECTION_ID, expr)
                    expr[Field.COLLECTION_ID] = arg
                elif field == Field.CODE:
                    self.check_field(Field.CODE, expr)
                    expr[Field.CODE] = arg
